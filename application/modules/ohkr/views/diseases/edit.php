        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?= site_url('okhr/diseases/lists') ?>" class="breadcrumb-item"> Diseases</a>
                    <span class="breadcrumb-item active">Edit Disease</span>
                </div>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
        </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <fieldset class="mb-3">
                    <legend class="text-uppercase font-size-sm font-weight-bold">Edit Disease</legend>
