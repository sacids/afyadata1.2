...
<?php if($this->project != 0){
    ...
    $project    = strtolower($this->project_tree[$this->project]['project']->title);
    ?>
            <li>
                <div data-fab-label="Add Member">
                    <a href="<?php echo base_url($project.'/member/add') ?>" class="btn btn-light rounded-round btn-icon btn-float">
            ...
            <li>
                <div data-fab-label="Add Group">
                    <a href="<?php echo base_url($project.'/group/add') ?>" class="btn btn-light rounded-round btn-icon btn-float">
            ...
            <li>
                <div data-fab-label="Add Form">
                    <a href="<?php echo base_url($project.'/form/add') ?>" class="btn btn-light rounded-round btn-icon btn-float">
