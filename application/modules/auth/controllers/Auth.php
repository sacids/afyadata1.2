...
class Auth extends CI_Controller
{
    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $this->load->view('auth/login_validation', $this->data);
            $this->load->view('ez/foot');
        }
    }

    /**
     * Self registration a new user
     */
    public function register()
    {
        ...
        if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
            ...
            $this->load->view('ez/head');
            $this->load->view('auth/login_registration', $this->data);
            $this->load->view('ez/foot');
    ...
    function set_password()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $reset = $this->ion_auth->set_password($identity, $this->input->post('new'));
            //$set    = $this->ion_auth->
            if ($reset) {
                //digest password
                ...
                $this->db->update('users', ['digest_password' => $digest_password], ['username' => $identity]);
                ...
                //
                $this->data['title'] = "Retry Change Password";
                $this->load->view('auth/set_password', $this->data);
