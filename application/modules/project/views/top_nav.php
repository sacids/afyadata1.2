...
<div class="navbar navbar-expand-md navbar-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        <ul class="navbar-nav">
            <li class="nav-item">
                <img src="<?php echo base_url(); ?>vendors/ad/images/logo_default.png" alt="AfyaData" height="35"
                     class="pt-2">
            </li>
                            ...
                            foreach ($this->project_tree as $project) {
                                ...
                                <li class="media">
                                    <div class="media-body">
                                        <a href="<?php echo base_url(str_replace(" ", "_", strtolower($project['project']->title))); ?>"
                                           class="media-title font-weight-semibold"><?php echo $project['project']->title; ?></a>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="<?php echo base_url(); ?>vendors/limitless/global_assets/images/placeholders/placeholder.jpg"
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="<?php echo base_url('auth/logout'); ?>" class="dropdown-item"><i class="icon-switch2"></i>
                        Logout</a>
                </div>
            </li>
        </ul>
